...
- `R2_ALLOWED_KEYS` (optional comma-separated allow-list; defaults to `issues/1/i.n.t.e.r.f.a.c.e..pdf`, which intentionally matches the current uploaded filename)
